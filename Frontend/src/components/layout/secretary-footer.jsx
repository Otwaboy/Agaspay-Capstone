export default function SecretaryFooter() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/secretary" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Dashboard</a>
            </li>
            <li>
              <a href="/secretary-dashboard/residents" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Resident Management</a>
            </li>
            <li>
              <a href="/secretary-dashboard/announcements" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Announcements</a>
            </li>
            <li>
              <a href="/secretary-dashboard/documents" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Documents</a>
            </li>
          </ul>
        </div>
