export default function TreasurerFooter() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/treasurer" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Dashboard</a>
            </li>
            <li>
              <a href="/treasurer-dashboard/payment-collection" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Payment Collection</a>
            </li>
            <li>
              <a href="/treasurer-dashboard/generate-bills" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Generate Bills</a>
            </li>
            <li>
              <a href="/treasurer-dashboard/analytics" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Financial Analytics</a>
            </li>
          </ul>
        </div>
