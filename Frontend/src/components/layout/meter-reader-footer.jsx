export default function MeterReaderFooter() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/meter-reader" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Dashboard</a>
            </li>
            <li>
              <a href="/meter-reader-dashboard/readings" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Meter Readings</a>
            </li>
            <li>
              <a href="/meter-reader-dashboard/assignments" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Assignments</a>
            </li>
            <li>
              <a href="/meter-reader-dashboard/settings" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Settings</a>
            </li>
          </ul>
        </div>
