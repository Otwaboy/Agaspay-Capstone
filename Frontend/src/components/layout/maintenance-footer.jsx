      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/maintenance" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Dashboard</a>
            </li>
            <li>
              <a href="/maintenance-dashboard/tasks" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Maintenance Tasks</a>
            </li>
            <li>
              <a href="/maintenance-dashboard/reports" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Reports</a>
            </li>
            <li>
              <a href="/maintenance-dashboard/settings" className="text-xs text-gray-600 hover:text-blue-600 transition-colors">Settings</a>
            </li>
          </ul>
        </div>
