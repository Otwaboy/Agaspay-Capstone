  ...
  const personnel = [
    {
      id: "PER-001",
      name: "Carlos Mendoza",
      email: "carlos.mendoza..agaspay.com",
      role: "admin",
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredPersonnel.map((person) => {
                        ...
                        return (
                          <tr key={person.id} data-testid={`row-personnel-${person.id}`}>
                            ...
                            <td className="py-4 px-6 text-sm text-gray-900">{person.department}</td>
                            <td className="py-4 px-6 text-sm text-gray-900">{person.zone}</td>
                            <td className="py-4 px-6">
                              <Badge className={statusConfig.className}>
                                {statusConfig.label}
                              </Badge>
                            </td>
                            <td className="py-4 px-6 text-sm text-gray-900">{person.joinDate}</td>
                            <td className="py-4 px-6">
                              <DropdownMenu>
